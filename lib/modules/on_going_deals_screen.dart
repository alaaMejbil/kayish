      ...
      child: BlocConsumer<OnGoingAuctionCubit, OnGoingStates>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              title: Text(
                  AppLocalization.of(context).translate('Ongoing Deals')!,
                  style: appBarTitle),
              centerTitle: true,
              elevation: 0.0,
              leading: IconButton(
            ...
            body: Conditional.single(
              ...
              widgetBuilder: (context) => cubit.onGoingAuctionModel != null
                  ? SmartRefresher(
                      ...
                      onLoading: () async {
                        cubit.getOnGoingAuction().then((value) {
                          ...
                          if (cubit.currentPage <
                              cubit.onGoingAuctionModel!.data!.nextAuctions!
                                  .total!) {
                                      ...
                                      itemBuilder: (context, index) => InkWell(
                                        onTap: () {
                                          if (CasheHelper.getData(
                                              key: isVerified)) {
                                            if (cubit.allData[index].endTime! *
                                                        1000 -
                                                    DateTime.now()
                                        ...
                                        child: UnitItem(
                                          ...
                                          onFollowTab: () {
                                            if (!CasheHelper.getData(
                                              ...
                                              cubit.currentFollowedList[cubit
